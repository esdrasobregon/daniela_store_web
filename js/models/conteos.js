...
class Conteos {
    ...
    async getAllConteos() {
        var allConteos = [];
        await firebaseAdmin.db.collection("conteos").get()
            .then((querySnapshot) => {
                querySnapshot.forEach(function (doc) {
                    var cont = {
                        idConteos: doc.id,
                        motivo: doc.data().motivo,
                        faltanteInicial: doc.data().faltanteInicial,
                        pendiente: doc.data().pendiente,
                        fechaRealizacion: doc.data().fechaRealizacion,
                        fechaSolicitud: doc.data().fechaSolicitud,
                        marcasTotales: doc.data().marcasTotales,
                        idChofer: doc.data().idChofer,
                        Bus: doc.data().Bus,
                    };
                    allConteos.push(cont);
...
const conteos = new Conteos();

module.exports =  conteos;